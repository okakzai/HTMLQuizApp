...
(function($){	
	...
	_lang = {
			ans:{	// _lang.ans are shown during the display of .q-result, the answer result.
				...
				praise: 'Great, lets move on!',
				retry: 'Not exactly.<br/>Try with other answers.',
				whyAns: "Info:",
				yourAns: "Your answer:"
			},
			btn:{	// [ "text", "title" ]
				begin: [ "Begin Quiz" ],
				check: [ "Check", "Check answers" ],
				del: [ "Delete", "Delete Quiz" ],
				help: [ "Guidance", 'Click for help'],
				next: [ "Continue", "The next question" ],
				restart: [ "Repeat", "Repeat the question of the beginning" ],
				details: [ "More", "Review the results of the quiz" ],
				review: [ "Review", "See answer proposed" ],
				showOnlyMissed: [ " *", "Click to see the answers neglected." ],
				quit: [ "Finish", "Stop playing quiz" ],
				quitNo: [ ">>", "Back" ],
				quitYes: [ '', "Yes, Stop" ]
			},
			err:{
